...
#### Updated
- Date formatter for ISO8601 dates to be lazily instantiated [Issue [#110](https://github.com/hkellaway/Gloss/issues/110)]
- Syntax for producing models arrays and JSON arrays (See [docs](https://github.com/hkellaway/Gloss#model-objects-from-json-arrays) for latest syntax) [PR [#116](https://github.com/hkellaway/Gloss/pull/116), [#117](https://github.com/hkellaway/Gloss/pull/117)]
